	<div class="content">
		<h2 id="page_title"><?php echo l('nightly.builds'); ?></h2>
	...
	<?php } ?>
		<h3>Statistics</h3>
		<ul>
			<li><b><?php echo l('nightly.x_builds', $stats['count']); ?></b></li>
			<li><b><?php echo round($stats['successful']); ?>%</b> <?php echo l('nightly.success_rate'); ?></li>
			<li><b><?php echo time_difference_in_words(time() - $stats['duration'], false); ?></b> <?php echo l('nightly.average_duration'); ?></li>
		</ul>
	</div>
	...
	<table class="list">
		<thead>
			...
			<th class="date" style="width: 65%"><?php echo l('nightly.build_date'); ?></th>
			<th class="duration" style="width: 15%"><?php echo l('nightly.build_duration'); ?></th>
			<th class="artifacts style="width: 10%""><?php echo l('nightly.artifacts'); ?></th>
		</thead>
		<tbody>
